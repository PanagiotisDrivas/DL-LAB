...
class SemanticFineTuner(FineTuner):
    ...
    dinov3_vit_model : str
        ViT model name of DINOv2. One of ['vits16', 'vitl16', 'vitg16', 'vitb16'].
    num_classes : int
    ...
    def __init__(self, dinov2_vit_model: str, dinov3_vit_model: str, dinov3:int, num_classes: int, debug: int, train_output_size: Tuple[int, int],
